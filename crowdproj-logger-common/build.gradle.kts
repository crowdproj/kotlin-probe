    ...
    sourceSets {
        ...
        val commonMain by getting {
            dependencies {
                ...
                implementation(project(":crowdproj-eventmanager-common"))
                implementation(project(":crowdproj-eventmanager-default"))
            }
        }
        ...
        val commonTest by getting {
            dependencies {
                ...
                implementation(project(":crowdproj-eventconsumer-mock"))
            }
        }
